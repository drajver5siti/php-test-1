 ...
 */
final class Version20220428122422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_post CHANGE content content LONGTEXT NOT NULL, CHANGE slug slug VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_post CHANGE content content TEXT NOT NULL, CHANGE slug slug VARCHAR(255) NOT NULL');
    }
}
